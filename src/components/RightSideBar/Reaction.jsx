...
export const Reaction = () => {
  ...
  const handleInput = () => {
    ...
    let response = [
      "I'm fine|Fine|fine|I am fine|I am fine today|I am fine today|i'm fine|i'm great|I'm fine|I'm great|I'm good|i'm good|great|Great",
    ];
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Team-S";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
